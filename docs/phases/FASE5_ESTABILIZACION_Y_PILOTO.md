...
2. p95 de endpoints dashboard/gamification: < 700ms.
3. Claims fallidos por validacion inesperada: < 5%.
4. Duplicidad de recompensa: 0 casos.
...
3. Export para dashboard externo (Prometheus):
`GET /ops/metrics/prometheus`

4. Estado de alertas:
`GET /ops/alerts/status`

5. Variables para alertas externas:
